...
#include <signal.h>
#include <time.h>
#include <pthread.h> //TODO: remove when using HW as need to swap with HW
    ...
    while (!stop) {
        ...
        case 2:
            ...
            if (num_objects > 50) {
                ...
                objs[num_objects].x = rand() % X_MAX;
                objs[num_objects].y = rand() % Y_MAX;
                objs[num_objects].d = rand() % NUM_DIRECTION;
            }
            break;
        case 3:
            --num_objects;

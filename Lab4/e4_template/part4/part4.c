...
void WaitForKey0(int stopwatch_fd, int key_fd, int sw_fd, int ledr_fd, 
...
int main(int argc, char *argv[]) {
    ...
    WaitForKey0(stopwatch_fd, key_fd, sw_fd, ledr_fd, 
    ...
    sleep(2); // Wait to clear HEX so you can see the zeros for stopwatch reach end

...
/* ARM Peripherals */
// word offset = need to access memory with int pointer, 4*(value below) = actual address
#define I2C0_BASE			  0xFFC04000		// base of I2C0 Controller
#define I2C0_CON              0x00000000		// word offset - Control reg
#define I2C0_TAR              0x00000001		// word offset - Target Addr reg
#define I2C0_DATA_CMD         0x00000004		// word offset - Tx/Rx data and cmd reg
#define I2C0_FS_SCL_HCNT      0x00000007		// word offset - SCL High Count Register (Fast Speed)
#define I2C0_FS_SCL_LCNT      0x00000008		// word offset - SCL Low Count Register (Fast Speed)
#define I2C0_ENABLE           0x0000001B		// word offset - Enable Register
#define I2C0_RXFLR            0x0000001E		// word offset - Receive FIFO Level Register
#define I2C0_ENABLE_STATUS    0x00000027		// word offset - Enable Status Register
#define I2C0_SPAN			  0x00000100		// span

#define SYSMGR_BASE			  0xFFD08000		// base - For Mux
